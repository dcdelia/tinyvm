...
B2:                                       ; preds = %B5, %entry
  %y.0 = phi i32* [ getelementptr inbounds ([16 x i32]* @s, i32 0, i32 0), %entry ], [ %v6, %B5 ]
  %x.0 = phi i32* [ getelementptr inbounds ([16 x i32]* @t, i32 0, i32 0), %entry ], [ %v8, %B5 ]
  %i.0 = phi i32 [ %v1, %entry ], [ %v3, %B5 ]
  %v3 = add nsw i32 %i.0, -1
  %v4 = icmp ne i32 %i.0, 0
  br i1 %v4, label %B5, label %B9

B5:                                       ; preds = %B2
  %v6 = getelementptr inbounds i32* %y.0, i32 1
  %v7 = load i32* %y.0, align 4
  %v8 = getelementptr inbounds i32* %x.0, i32 1
  store i32 %v7, i32* %x.0, align 4
  br label %B2
...
B10:                                      ; preds = %B23, %B9
  %i.1 = phi i32 [ 1, %B9 ], [ %v22, %B23 ]
  %v11 = load i32* getelementptr inbounds ([16 x i32]* @t, i32 0, i64 0), align 4
  %v12 = sext i32 %v11 to i64
  %v13 = getelementptr inbounds i32* getelementptr inbounds ([16 x i32]* @t, i32 0, i32 0), i64 %v12
  br label %B14

B14:                                      ; preds = %B16, %B10
  %y.1 = phi i32* [ %v13, %B10 ], [ %v20, %B16 ]
  %x.1 = phi i32* [ getelementptr inbounds ([16 x i32]* @t, i32 0, i32 0), %B10 ], [ %v19, %B16 ]
  %v15 = icmp ult i32* %x.1, %y.1
  br i1 %v15, label %B16, label %B21

B16:                                      ; preds = %B14
  %v17 = load i32* %x.1, align 4
  %v18 = load i32* %y.1, align 4
  %v19 = getelementptr inbounds i32* %x.1, i32 1
  store i32 %v18, i32* %x.1, align 4
  %v20 = getelementptr inbounds i32* %y.1, i32 -1
  store i32 %v17, i32* %y.1, align 4
  br label %B14

B21:                                      ; preds = %B14
  %v22 = add nsw i32 %i.1, 1
  br label %B23

B23:                                      ; preds = %B21
  %v24 = load i32* getelementptr inbounds ([16 x i32]* @t, i32 0, i64 0), align 4
  %v25 = sext i32 %v24 to i64
  %v26 = getelementptr inbounds [16 x i32]* @t, i32 0, i64 %v25
  %v27 = load i32* %v26, align 4
  %v28 = icmp ne i32 %v27, 0
  br i1 %v28, label %B10, label %B29
