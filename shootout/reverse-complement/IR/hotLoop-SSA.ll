...
define i32 @hotLoop(i64* %p_hotLoopCounter, %struct._IO_FILE* %inputFile, i8* %pj, i8* %pq, i8* %pr, i8* %jjj, i8* %qqq, i8* %pqstop, i8* %xtab) #0 {
  %1 = load i64* %p_hotLoopCounter, align 8
  %2 = add nsw i64 %1, 1
  store i64 %2, i64* %p_hotLoopCounter, align 8
  %3 = call i8* @fgets(i8* %jjj, i32 82, %struct._IO_FILE* %inputFile)
  %4 = icmp ne i8* %3, null
  br i1 %4, label %5, label %9

; <label>:5                                       ; preds = %0
  %6 = load i8* %jjj, align 1
  %7 = sext i8 %6 to i32
  %8 = icmp eq i32 %7, 62
...
; <label>:10                                      ; preds = %5
  %11 = getelementptr inbounds i8* %pq, i64 61
  %12 = icmp ule i8* %pr, %11
  br i1 %12, label %13, label %42

; <label>:13                                      ; preds = %10
  %14 = getelementptr inbounds i8* %pqstop, i64 12777888
  %15 = ptrtoint i8* %14 to i64
  %16 = ptrtoint i8* %qqq to i64
  %17 = sub i64 %15, %16
  %18 = call i8* @realloc(i8* %qqq, i64 %17) #4
  %19 = icmp ne i8* %18, null
  br i1 %19, label %22, label %20

; <label>:20                                      ; preds = %13
  %21 = call i32 @errex(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0), i32 0)
  call void @exit(i32 %21) #5
  unreachable

; <label>:22                                      ; preds = %13
  %23 = icmp ne i8* %18, %qqq
  br i1 %23, label %24, label %33

; <label>:24                                      ; preds = %22
  %25 = ptrtoint i8* %18 to i64
  %26 = ptrtoint i8* %qqq to i64
  %27 = sub i64 %25, %26
  %28 = getelementptr inbounds i8* %pq, i64 %27
  %29 = getelementptr inbounds i8* %pr, i64 %27
  %30 = getelementptr inbounds i8* %qqq, i64 %27
  %31 = getelementptr inbounds i8* %14, i64 %27
  %32 = getelementptr inbounds i8* %pqstop, i64 %27
  br label %33

; <label>:33                                      ; preds = %24, %22
  %.03 = phi i8* [ %29, %24 ], [ %pr, %22 ]
  %.01 = phi i8* [ %32, %24 ], [ %pqstop, %22 ]
  %newstop.0 = phi i8* [ %31, %24 ], [ %14, %22 ]
  %34 = ptrtoint i8* %.01 to i64
  %35 = ptrtoint i8* %.03 to i64
  %36 = sub i64 %34, %35
  %37 = sub i64 0, %36
  %38 = getelementptr inbounds i8* %newstop.0, i64 %37
  %39 = ptrtoint i8* %.01 to i64
  %40 = ptrtoint i8* %.03 to i64
  %41 = sub i64 %39, %40
  call void @llvm.memmove.p0i8.p0i8.i64(i8* %38, i8* %.03, i64 %41, i32 1, i1 false)
  br label %42

; <label>:42                                      ; preds = %33, %10
  %.1 = phi i8* [ %38, %33 ], [ %pr, %10 ]
  br label %43

; <label>:43                                      ; preds = %55, %42
  %.2 = phi i8* [ %.1, %42 ], [ %.3, %55 ]
  %.02 = phi i8* [ %3, %42 ], [ %47, %55 ]
  %44 = load i8* %.02, align 1
  %45 = icmp ne i8 %44, 0
  br i1 %45, label %46, label %56

; <label>:46                                      ; preds = %43
  %47 = getelementptr inbounds i8* %.02, i32 1
  %48 = load i8* %.02, align 1
  %49 = zext i8 %48 to i64
  %50 = getelementptr inbounds i8* %xtab, i64 %49
  %51 = load i8* %50, align 1
  %52 = icmp ne i8 %51, 0
  br i1 %52, label %53, label %55

; <label>:53                                      ; preds = %46
  %54 = getelementptr inbounds i8* %.2, i32 -1
