...
B1:                                       ; preds = %B21, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %v22, %B21 ]
  %v2 = icmp slt i32 %i.0, %N
  br i1 %v2, label %B3, label %B23

B3:                                       ; preds = %B1
  %v4 = sext i32 %i.0 to i64
  %v5 = getelementptr inbounds double* %Au, i64 %v4
  store double 0.000000e+00, double* %v5, align 8
  br label %B6

B6:                                       ; preds = %B18, %B3
  %j.0 = phi i32 [ 0, %B3 ], [ %v19, %B18 ]
  %v7 = icmp slt i32 %j.0, %N
  br i1 %v7, label %B8, label %B20

B8:                                       ; preds = %B6
  %v9 = call double @eval_A(i32 %i.0, i32 %j.0)
  %v10 = sext i32 %j.0 to i64
  %v11 = getelementptr inbounds double* %u, i64 %v10
  %v12 = load double* %v11, align 8
  %v13 = fmul double %v9, %v12
  %v14 = sext i32 %i.0 to i64
  %v15 = getelementptr inbounds double* %Au, i64 %v14
  %v16 = load double* %v15, align 8
  %v17 = fadd double %v16, %v13
  store double %v17, double* %v15, align 8
  br label %B18

B18:                                      ; preds = %B8
  %v19 = add nsw i32 %j.0, 1
  br label %B6
...
B8:                                       ; preds = %B6
  %v9 = call double @eval_A(i32 %j.0, i32 %i.0)
  %v10 = sext i32 %j.0 to i64
  %v11 = getelementptr inbounds double* %u, i64 %v10
  %v12 = load double* %v11, align 8
  %v13 = fmul double %v9, %v12
