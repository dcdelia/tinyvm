...
entry:
  ...
  %v1 = bitcast [5 x %struct.planet]* %bodies to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %v1, i8* bitcast ([5 x %struct.planet]* @bodies_orig to i8*), i64 280, i32 16, i1 false)
  %v2 = getelementptr inbounds [5 x %struct.planet]* %bodies, i64 0, i64 0
  call void @offset_momentum(i32 5, %struct.planet* %v2)
  %v4 = call double @energy(i32 5, %struct.planet* %v2)
  %v5 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), double %v4) #2
  %v71 = icmp slt i32 %inputN, 1
  br i1 %v71, label %B12, label %B8.preheader

B8.preheader:                                     ; preds = %entry
  br label %B8

B8:                                               ; preds = %B8.preheader, %B8
  %i.02 = phi i32 [ %v11, %B8 ], [ 1, %B8.preheader ]
  call void @advance(i32 5, %struct.planet* %v2, double 1.000000e-02)
  %v11 = add nuw nsw i32 %i.02, 1
  %exitcond = icmp eq i32 %i.02, %inputN
  br i1 %exitcond, label %B12.loopexit, label %B8

B12.loopexit:                                     ; preds = %B8
  br label %B12

B12:                                              ; preds = %B12.loopexit, %entry
  %v14 = call double @energy(i32 5, %struct.planet* %v2)
  %v15 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), double %v14) #2
  ret i32 0
}
