...
entry:
  ...
  %v2 = getelementptr inbounds [5 x %struct.planet]* %bodies, i32 0, i32 0
  call void @offset_momentum(i32 5, %struct.planet* %v2)
  %v3 = getelementptr inbounds [5 x %struct.planet]* %bodies, i32 0, i32 0
  %v4 = call double @energy(i32 5, %struct.planet* %v3)
  %v5 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), double %v4)
  br label %B6

B6:                                       ; preds = %B10, %entry
  %i.0 = phi i32 [ 1, %entry ], [ %v11, %B10 ]
  %v7 = icmp sle i32 %i.0, %inputN
  br i1 %v7, label %B8, label %B12

B8:                                       ; preds = %B6
  %v9 = getelementptr inbounds [5 x %struct.planet]* %bodies, i32 0, i32 0
  call void @advance(i32 5, %struct.planet* %v9, double 1.000000e-02)
  br label %B10

B10:                                      ; preds = %B8
  %v11 = add nsw i32 %i.0, 1
  br label %B6

B12:                                      ; preds = %B6
  %v13 = getelementptr inbounds [5 x %struct.planet]* %bodies, i32 0, i32 0
  %v14 = call double @energy(i32 5, %struct.planet* %v13)
  %v15 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), double %v14)
  ret i32 0
}
