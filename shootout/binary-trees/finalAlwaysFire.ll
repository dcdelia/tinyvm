...
entry:
  %v1 = getelementptr inbounds %struct.tn* %tree, i32 0, i32 0
  %v2 = load %struct.tn** %v1, align 8
  %v3 = icmp ne %struct.tn* %v2, null
  br label %INSTR0

INSTR0:                                   ; preds = %entry
  br i1 %v3, label %B4, label %B9

B4:                                       ; preds = %INSTR0
  %v5 = getelementptr inbounds %struct.tn* %tree, i32 0, i32 0
  %v6 = load %struct.tn** %v5, align 8
  call void @DeleteTree(%struct.tn* %v6)
  %v7 = getelementptr inbounds %struct.tn* %tree, i32 0, i32 1
  %v8 = load %struct.tn** %v7, align 8
  call void @DeleteTree(%struct.tn* %v8)
  br label %B9

B9:                                       ; preds = %B4, %INSTR0
  %v10 = bitcast %struct.tn* %tree to i8*
  call void @free(i8* %v10) #3
  ret void
}
